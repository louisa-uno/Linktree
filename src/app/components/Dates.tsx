export function Dates(): { daysOnHrt: string; age: string } {
	...
	function calculateDifference(targetDate: Date, isPast: boolean) {
		const now = new Date();
	...
	const daysOnHrt = formatDuration(
		e2Diff.years,
		e2Diff.months,
		e2Diff.days
	);
